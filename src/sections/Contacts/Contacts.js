      ...
      <div className="container">
        <div className="contacts__main-wrapper">  
          ...
          <div className="contacts__wrapper">
            ...
            <a href="index.html" className="contacts__telegram alt-button" onClick={(e) => {e.preventDefault(); alert('Тоже согласуем тогда)')}}>
            ...
            <a href="index.html" className="contacts__email alt-button" onClick={(e) => {e.preventDefault(); alert('Тоже согласуем тогда)')}}>
