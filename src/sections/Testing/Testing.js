    ...
    <section id="testing" className="testing section-wrap">
      <div className="container">
        <div className="testing__wrapper">
          ...
          <svg className="testing__glare testing__glare--320" width="169" height="255" viewBox="0 0 169 255" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg className="testing__glare testing__glare--740" width="292" height="618" viewBox="0 0 292 618" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="testing__list--740">
